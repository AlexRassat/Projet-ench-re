			...
			<div class="col-12">
				<div class="col-6">
					...
					<label for="telephone" class="col-2 col-form-label">Téléphone :</label>
  					<div class="col-10">
						<input class="form-control" type="tel" id="telephone_utilisateur" name="telephone_utilisateur" value="" maxlength="10">
					</div>
					<label for="code_postal" class="col-2 col-form-label">Code postal* :</label>
  					<div class="col-10">
						<input class="form-control" type="text" id="code_postal_utilisateur" name="code_postal_utilisateur" value="" maxlength="5">
					</div>
